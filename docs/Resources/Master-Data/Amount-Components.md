...
| `cashback` | *number* | 12 | For Debit, EBTCash, or Credit: The amount of cash requested by the cardholder at the time of purchase. Not supported on Visa, Mastercard or Signature Debit. |
