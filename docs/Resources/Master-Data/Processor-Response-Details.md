...
| `arqcResponseCode` | *string* | 32 | An ARQC *(Authorization Request Cryptogram)* generated by the EMV card upon request from the pos terminal to obtain authorization for payment. ***Valid Values:** VALIDATION_FAILED, VALIDATION_UNAVAILABLE, UNAVAILABLE, VALIDATION_BYPASSED, or VALIDATION_PASSED* |
