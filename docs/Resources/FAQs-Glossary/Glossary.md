...
A hybrid card combines both debit and credit card functionality in a single card. Based on the routing choice it allows the customer to be charged immediately using debit processing or a later date using credit processing.
