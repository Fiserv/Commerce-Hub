...
<!-- theme: danger -->
> We are enhancing Commerce Hub to include account verification transaction. The documents related to the features will be released soon.

The merchant can perform account verification transaction to confirm that the cardholder account is valid for a transaction. The merchant can initiate the verification request using a payment card or token.
