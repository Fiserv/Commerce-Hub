---
tags: [Forced Post, Payments, API Documents, API Reference, Authorization, Sale, Pre Auth]
---

# Forced Post

<!-- theme: danger -->
> We are enhancing the Commerce Hub to include forced post transactions and the documents related to the features will be released soon.
