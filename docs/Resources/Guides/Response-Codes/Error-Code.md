...
|	453 |	Counter Offer to Supply Personal G|uaranty	| 	 
|	454 |	Need Additional Identification: Re|quest Full SSN |	 	 
...
|	631	| Velocity: Transaction Limit Exceeded	2xx |
|	632 |	Velocity: Max Amount Per Merchant Per Time-Box Exceeded	2xx | 
...
|	691	| Batch Upload Error: Unknown	| 	 
...
752	Invalid Status Change: Unable to Perform Change	 	 
 	753	Unable to Write Transaction to Database	 	 
...
834	Unable to Cancel: Missing Amount	 	 
 	835	Unable to Cancel: Amount is Greater than Original Transaction	 
...
841	Forced Post Sent Without Approval Code	 	 
 	842	Incremental Auth Not Allowed: Transaction Captured	 	 
