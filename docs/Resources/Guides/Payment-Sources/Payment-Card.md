...
<!-- theme: info -->
> PIN-less Debit transaction process via the credit network unless the merchant account is setup for debit processing. Please contact your account representitive for more information on debit processing.
