...
Multi-Currency Pricing (MCP) is available for [online, digital, and mobile integrations](?path=docs/Getting-Started/Getting-Started-Online.md) and allows merchants to set static pricing in multiple currencies. MCP provides the most control for specific international markets and offers customers an _in country_ shopping experience. Merchants are responsible for setting and maintaining the prices in the currencies they support in their experiences
...
- Reduce shopping cart abandonment and improve sales conversion at checkout
