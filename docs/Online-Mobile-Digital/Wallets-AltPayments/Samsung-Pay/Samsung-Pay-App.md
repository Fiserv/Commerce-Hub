...
# Samsung Pay: In-App Integration

## Step 1: Configure Samsung Pay in App

Configure Samsung developer account with merchant information to accept [Samsung Pay in the App](https://help.apple.com/developer-account/#/devb2e62b839). This includes creating a merchant identifier, enabling Apple Pay in App and creating a processing certificate.
