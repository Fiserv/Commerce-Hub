...
Configure Apple developer account with merchant information to accept [Apple Pay on the web](https://help.apple.com/developer-account/#/dev1731126fb). creating a merchant identifier `applePayMerchantId` and processing certificate in [Developer Studio](?path=docs/Resources/Guides/Dev-Studio/Certificate-Management.md), registering the merchant and creating a merchant identity certificate.
