...
Configure Apple developer account with merchant information to accept [Apple Pay in the App](https://help.apple.com/developer-account/#/devb2e62b839). This includes creating a merchant identifier `applePayMerchantId` and processing certificate in [Developer Studio](?path=docs/Resources/Guides/Dev-Studio/Certificate-Management.md) and enabling Apple Pay in App.

- When using *ApplePay*, the merchant will utilize the [certificate](?path=docs/Resources/Guides/Dev-Studio/Certificate-Management.md) generated by Commerce Hub.
