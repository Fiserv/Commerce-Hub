...
The merchant uses a [multi-use public key _(MUPK)_](?path=docs/Online-Mobile-Digital/Checkout/Multi-Use-Public-Key/Multi-Use-Public-Key-Management.md) for the asymmeteric _PaymentCard_ encryption of the card data where the merchant can store and send the data to Commerce Hub at a later time.
...
A [generate key](?path=docs/Online-Mobile-Digital/Checkout/Multi-Use-Public-Key/Multi-Use-Public-Key-Management.md#generate-key) request is required  to receive a base64 encoded encryption key. This key is used to encrypt the `encryptionBlock` that was created in step 1.
...
- [Multi-Use Public Key](?path=docs/Online-Mobile-Digital/Checkout/Multi-Use-Public-Key/Multi-Use-Public-Key.md)
...
- [Multi-Use Public Key Charges Request](?path=docs/Online-Mobile-Digital/Checkout/Multi-Use-Public-Key/Multi-Use-Public-Key-Request.md)
- [Checkout API Only](?path=docs/Online-Mobile-Digital/Checkout/API/API-Only.md)
